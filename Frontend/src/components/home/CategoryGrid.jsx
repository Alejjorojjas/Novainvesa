      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        {categories.map(cat => (
          <Link
            ...
            className="group flex flex-col items-center gap-3 p-5 bg-white rounded-2xl shadow-sm hover:shadow-md border border-transparent hover:border-neutral-200 transition-all duration-200"
          >
            <span
